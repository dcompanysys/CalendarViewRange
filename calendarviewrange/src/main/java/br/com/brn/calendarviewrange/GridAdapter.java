...
public class GridAdapter extends ArrayAdapter {
    ...
    public GridAdapter(@NonNull Context context, @NonNull CalendarData calendarData, int shiftMonth, @Nullable DateSelectListener listener, GridChangeListener gridListener) {
