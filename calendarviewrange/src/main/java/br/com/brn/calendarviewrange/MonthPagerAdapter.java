...
import br.com.brn.calendarviewrange.listeners.GridChangeListener;
...
public class MonthPagerAdapter extends PagerAdapter {
    ...
    MonthPagerAdapter(CalendarData calendarData, DateSelectListener listener) {
    ...
    public Object instantiateItem(@NonNull final ViewGroup container, final int position) {
        ...
        final GridAdapter adapter = new GridAdapter(container.getContext(), calendarData, indexShift, listener, new GridChangeListener() {
            @Override
        ...
        weekDays.set(Calendar.DAY_OF_WEEK, calendarData.isFirstMonday() ? 2 : 1);
        ...
        weekDays.set(Calendar.DAY_OF_WEEK, calendarData.isFirstMonday() ? 3 : 2);
        ...
        weekDays.set(Calendar.DAY_OF_WEEK, calendarData.isFirstMonday() ? 4 : 3);
        ...
        weekDays.set(Calendar.DAY_OF_WEEK, calendarData.isFirstMonday() ? 5 : 4);
        ...
        weekDays.set(Calendar.DAY_OF_WEEK, calendarData.isFirstMonday() ? 6 : 5);
        ...
        weekDays.set(Calendar.DAY_OF_WEEK, calendarData.isFirstMonday() ? 7 : 6);
        ...
        weekDays.set(Calendar.DAY_OF_WEEK, calendarData.isFirstMonday() ? 1 : 7);
